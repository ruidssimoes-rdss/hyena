<GuideLayout
  title="Accessibility"
  description="Accessibility features, ARIA attributes, and keyboard interactions in Hyena components."
>

## Overview

Hyena components are built with accessibility in mind. This guide documents ARIA attributes, keyboard interactions, screen reader behavior, and focus management for key components.
...
Hyena components include visible focus indicators. Never remove them:
