<GuideLayout
  title="Patterns"
  description="Common patterns and conventions used throughout Hyena components."
>
...
<InfoCard title="Why Compound Components?">
...
<FeatureGrid>
  <FeatureCard
    title="Uncontrolled"
    description="Simple forms, quick prototypes. Component manages its own state."
  />
  <FeatureCard
    title="Controlled"
    description="Complex forms, validation, derived state. You manage state externally."
  />
</FeatureGrid>
