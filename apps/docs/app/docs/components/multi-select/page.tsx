...
import { multiSelectData } from '../../../../lib/componentRegistry';
import {
...
} from '../../../../components/previews/MultiSelectPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': MultiSelectBasicPreview,
  'with-search': MultiSelectWithSearchPreview,
  'max-items': MultiSelectMaxItemsPreview,
  'creatable': MultiSelectCreatablePreview,
  'grouped': MultiSelectGroupedPreview,
  'disabled': MultiSelectDisabledPreview,
};
...
function MultiSelectPageContent() {
  const searchParams = useSearchParams();
  const variantParam = searchParams.get('variant');

  return (
    <PlaygroundLayout
      componentData={multiSelectData}
