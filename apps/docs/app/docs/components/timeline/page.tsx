...
import { timelineData } from '../../../../lib/componentRegistry';
import {
...
} from '../../../../components/previews/TimelinePreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': TimelineBasicPreview,
  'with-icons': TimelineWithIconsPreview,
  'with-timestamps': TimelineWithTimestampsPreview,
  'alternating': TimelineAlternatingPreview,
  'status-indicators': TimelineStatusIndicatorsPreview,
  'activity-feed': TimelineActivityFeedPreview,
};
