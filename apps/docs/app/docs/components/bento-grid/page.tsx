...
import { bentoGridData } from '../../../../lib/componentRegistry';
import {
...
} from '../../../../components/previews/BentoGridPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': BentoGridBasicPreview,
  'spanning': BentoGridSpanningPreview,
  'responsive': BentoGridResponsivePreview,
  'dashboard': BentoGridDashboardPreview,
  'marketing': BentoGridMarketingPreview,
};
...
function BentoGridPageContent() {
  const searchParams = useSearchParams();
  const variantParam = searchParams.get('variant');

  return (
    <PlaygroundLayout
      componentData={bentoGridData}
