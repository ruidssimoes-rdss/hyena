...
import { masonryData } from '../../../../lib/componentRegistry';
import {
  MasonryBasicPreview,
...
} from '../../../../components/previews/MasonryPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': MasonryBasicPreview,
  'responsive': MasonryResponsivePreview,
  'image-gallery': MasonryImageGalleryPreview,
  'card-grid': MasonryCardGridPreview,
  'load-more': MasonryLoadMorePreview,
};
